...
class FrankaPlaying(BaseTask):
    ...
    def __init__(self, name):
        ...
        self._goal_position = np.array([0.10, -0.50, 0.20])
    ...
    def set_up_scene(self, scene):
        ...
        self._cubeA = scene.add(DynamicCuboid(prim_path="/World/cubeA",
                                            name="cubeA",
                                            position=np.array([-0.3, 0.6, 0.13]),
        ...
        self._cubeB = scene.add(DynamicCuboid(prim_path="/World/cubeB",
                                            name="cubeB",
                                            position=np.array([0.10, -0.5, 0.13]),
...
class WarehouseTask2Manual(BaseSample):
    ...
    def setup_scene(self):
        ...
        world.add_task(FrankaPlaying(name="task_2"))
        return
    ...
    async def setup_post_load(self):
        ...
        self._controller = PickPlaceController(
            ...
            events_dt =  [0.008, 0.005, 10, 10, 10, 10, 0.0025, 10, 0.1, 0.08]  #pickup velocity
